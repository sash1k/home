...
permalink: /hackthebox-mirai-writeup/
excerpt: "Mirai is an easy-rated box from HacktheBox. It explores the Raspberry Pi default ssh credentials and becomes root with a simple command. Then, it needs to recover the deleted flag file from usb stick."
classes: wide
header:
...
tags:
  - pi-hole
  - raspberry-pi-default-creds-ssh
...
![hackthebox mirai title card](/assets/images/htb/mirai/Mirai.png)
...
# <font color="#9bffc8">Http: mirai.htb</font>
...
![main page](/assets/images/htb/mirai/main-page.png)

# <font color="#9bffc8">Http: pi.hole/admin</font>
...
![login error](/assets/images/htb/mirai/login-error.png)
...
![ssh in as pi](/assets/images/htb/mirai/ssh-in-as-user.png)

# <font color="#9bffc8">PrivEsc: Sudo</font>
...
![root shell](/assets/images/htb/mirai/root-shell.png)

# <font color="#9bffc8">Flag: Root</font>
...
![root deleted](/assets/images/htb/mirai/root-deleted.png)
...
![cd usbstick](/assets/images/htb/mirai/cd-into-usbstick.png)
...
![shit.txt](/assets/images/htb/mirai/shit-txt.png)
