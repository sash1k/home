...
permalink: /hackthebox-sunday-writeup/
excerpt: "Sunday is an easy Linux machine from HacktheBox. It explores the finger on port 79 for enumerating users. Then, brute-force the ssh password or guess it for the foothold. Finally, abused the wget command to privilege escalation."
classes: wide
header:
  teaser: "/assets/images/htb/sunday/Sunday.png"
...
![hackthebox sunday title card](/assets/images/htb/sunday/Sunday.png)
...
![etc hosts file](/assets/images/htb/sunday/etc-hosts.png)

# <font color="#9bffc8">Finger: User enumeration</font>
...
![finger user enum](/assets/images/htb/sunday/run-finger-user-enum.png)

# <font color="#9bffc8">Foothold: SSH</font>
...
![ssh sunny](/assets/images/htb/sunday/ssh-sunny.png)
...
![sudo troll](/assets/images/htb/sunday/run-sudo-troll.png)
...
![path abused](/assets/images/htb/sunday/path-abused-with-id.png)

# <font color="#9bffc8">Backup: Shadow.backup</font>
...
![john the ripper sammy](/assets/images/htb/sunday/john-sammy.png)

# <font color="#9bffc8">PrivEsc: Wget</font>
...
![ssh sammy](/assets/images/htb/sunday/ssh-sammy.png)
...
![me root](/assets/images/htb/sunday/me-root.png)
