...
![hackthebox paper title card](/assets/images/htb/paper/Paper.png)
...
![apache default page after installation](/assets/images/htb/paper/webpage-1.png)
...
![running the curl command to get the header of the server](/assets/images/htb/paper/curl-head.png)

![adding the hostname in etc host file](/assets/images/htb/paper/etc-hosts-office-paper.png)
...
![office.paper using wordpress website](/assets/images/htb/paper/office-paper-home.png)
...
![comment says the drafts is not secure](/assets/images/htb/paper/office-paper-drafts.png)
...
![reading the unsecure draft and found secret links with new hostname](/assets/images/htb/paper/office-paper-drafts-secret.png)

![adding the new hostname found in etc host file](/assets/images/htb/paper/etc-hosts-chat-office-paper.png)
...
![spotting bot called recyclops in rocket.chat](/assets/images/htb/paper/recyclops-general.png)
...
![list all commands in a recyclops bot](/assets/images/htb/paper/recyclops-help.png)
...
![recyclops list all directory in a server](/assets/images/htb/paper/recyclops-list-dot2.png)
...
![recyclops reveals the credentials](/assets/images/htb/paper/hubot-env-pass.png)
...
![running the bash reverse shell in rocket.chat using recyclops run command](/assets/images/htb/paper/recyclops-run.png)

![catch the reverse shell using netcat](/assets/images/htb/paper/foothold-as-dwight.png)
...
![upload the linpeas script in the target machine and run it](/assets/images/htb/paper/run-the-linpeas-as-dwight.png)
...
![linpeas found that this machine is vulnerable to CVE-2021-3560](/assets/images/htb/paper/linpeas-find-CVE-2021-3560.png)
...
![upload proof of concept bash script in the target machine and make it executable](/assets/images/htb/paper/download-the-poc-script-on-victim-machine.png)

![running the proof of concept bash script and get the root shell](/assets/images/htb/paper/run-the-script-and-get-the-root-shell.png)
